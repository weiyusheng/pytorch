...
class ConvertFrameAssert:
    ...
    def _clone_with_backend(self, backend):
        return lambda backend: convert_frame_assert(backend, self.one_graph, self.export, self.export_constraints)
...
class ConvertFrame:
    ...
    def _clone_with_backend(self):
        return lambda backend: convert_frame(backend, self.hooks)
